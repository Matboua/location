					...
					<div className="-mx-4 flex flex-wrap justify-between">
						...
						<div className="px-4 my-5 w-full xl:w-1/4">
							...
							<p className="text-justify">
								...
								Agadir, we provide seamless pick-up services across all of
								Morocco.
							</p>
						</div>
						{/* Second */}
						<div className="px-4 my-4 w-full sm:w-auto">
							...
							<ul className="leading-8">
								...
								<li>
									<Link to="/articles" className="hover:text-blue-400">
										Articles Page
									</Link>
								</li>
								<li>
						...
						<div className="px-4 flex flex-col gap-5 my-4 w-full sm:w-auto xl:w-1/4">
							{/* Title */}
							<div>
								<h2 className="inline-block text-2xl pb-4 border-b-4 border-blue-600">
									Stay Connected
								</h2>
							</div>
							{/* Social Media */}
							<div className="flex gap-3">
								<a
									...
									target="_blank"
									className="inline-flex items-center justify-center h-8 w-8 border dark:border-gray-100 rounded-full mr-1 hover:text-blue-400 hover:border-blue-400"
								>
								...
								<a
									href="https://www.linkedin.com/in/matboua/"
									target="_blank"
									className="inline-flex items-center justify-center h-8 w-8 border dark:border-gray-100 rounded-full hover:text-blue-400 hover:border-blue-400"
								>
							...
							>
								...
								<input
									className="p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border-2 border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white focus:outline-0 focus:border-blue-600"
								...
								<button
									type="submit"
									className="absolute right-0 top-[50%] mr-[6px] w-9 h-9 rounded-lg bg-blue-600 text-white cursor-pointer"
