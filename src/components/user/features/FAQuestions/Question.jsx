...
export default function Question({ title, description }) {
	return (
		<div className="dark:bg-gray-900 bg-white dark:text-gray-100 border dark:border-gray-700 border-gray-300 rounded-lg shadow-lg overflow-hidden">
			...
			<label
				htmlFor={title}
				className="flex items-center justify-between p-4 dark:bg-[#03071230] bg-gray-50 cursor-pointer hover:bg-blue-100 dark:hover:bg-gray-2-50 dark:peer-checked:bg-gray-3-60 transition-colors peer-checked:bg-blue-100 dark:peer-checked:bg-gray-2-50"
			>
